...
type EntityResponseType = HttpResponse<ILivreur>;
type EntityArrayResponseType = HttpResponse<ILivreur[]>;

@Injectable({ providedIn: 'root' })
export class LivreurService {
  public resourceUrl = SERVER_API_URL + 'api/livreurs';
  ...
  update(livreur: ILivreur): Observable<EntityResponseType> {
    return this.http.put<ILivreur>(this.resourceUrl, livreur, { observe: 'response' });
  }
