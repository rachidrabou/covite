...
/**
 * REST controller for managing {@link com.pfe.covite.domain.TarifTransport}.
 */
@RestController
@RequestMapping("/api")
public class TarifTransportResource {
    ...
    public ResponseEntity<TarifTransport> createTarifTransport(@RequestBody TarifTransport tarifTransport) throws URISyntaxException {
    ...
    public ResponseEntity<TarifTransport> updateTarifTransport(@RequestBody TarifTransport tarifTransport) throws URISyntaxException {
